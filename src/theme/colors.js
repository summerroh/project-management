...
export const gradient = {
  ...
  skybluetoblue: "linear-gradient(to right, #22A7FF, #1C82FF)",
  purpletopurple: "linear-gradient(to right, #7C5CF4, #4E2BF4)",
  orangetoyellow: "linear-gradient(to right, #F47F09, #FEB92E)",
